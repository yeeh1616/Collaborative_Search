...
var _linkifyIt = __webpack_require__(22);

var _linkifyIt2 = _interopRequireDefault(_linkifyIt);

var _tlds = __webpack_require__(28);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "Launcher", function() { return /* reexport */ components_Launcher; });

// EXTERNAL MODULE: ./src/styles/emojiPicker.css
var emojiPicker = __webpack_require__(13);

// EXTERNAL MODULE: ./src/styles/chat-window.css
var chat_window = __webpack_require__(14);

// EXTERNAL MODULE: ./src/styles/launcher.css
var launcher = __webpack_require__(15);
...
var popup_window = __webpack_require__(19);
...
var Linkify = __webpack_require__(6);
...
var TextMessage_TextMessage = function TextMessage(props) {
  ...
  var dateString = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("div", {
  ...
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Linkify_default.a, {
    properties: {
      target: '_blank'
    }
  }, props.data.text), dateString);
};
...
var FileMessage_FileMessage = function FileMessage(props) {
  ...
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(icons_FileIcon, null), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("p", null, props.data.fileName), dateString);
};
...
var identicon = __webpack_require__(7);
var identicon_default = /*#__PURE__*/__webpack_require__.n(identicon);
...
function Messages_createSuper(Derived) { return function () { var Super = Messages_getPrototypeOf(Derived), result; if (Messages_isNativeReflectConstruct()) { var NewTarget = Messages_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return Messages_possibleConstructorReturn(this, result); }; }

function Messages_possibleConstructorReturn(self, call) { if (call && (typeof call === "object" || typeof call === "function")) { return call; } return Messages_assertThisInitialized(self); }
...
function Messages_inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
var Messages_Message = /*#__PURE__*/function (_Component) {
  Messages_inheritsLoose(Message, _Component);

  var _super = Messages_createSuper(Message);
  ...
  _proto._renderMessageOfType = function _renderMessageOfType(type) {
    switch (type) {
      case 'text':
        return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Messages_TextMessage, this.props.message);

      case 'emoji':
        return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Messages_EmojiMessage, this.props.message);

      case 'file':
        return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Messages_FileMessage, this.props.message);
  ...
  _proto.render = function render() {
    ...
    var data = new identicon_default.a(md5_default()(this.props.message.sender), options).toString();
    ...
    var sentClass = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("div", {
      className: contentClassList.join(' ')
    }, this._renderMessageOfType(this.props.message.type), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("div", {
      className: "sc-message--avatar",
      style: {
        backgroundImage: "url(" + chatIconUrl + ")"
      }
    }));
    var receiveClass = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("div", {
      className: contentClassList.join(' ')
...
function MessageList_createSuper(Derived) { return function () { var Super = MessageList_getPrototypeOf(Derived), result; if (MessageList_isNativeReflectConstruct()) { var NewTarget = MessageList_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return MessageList_possibleConstructorReturn(this, result); }; }

function MessageList_possibleConstructorReturn(self, call) { if (call && (typeof call === "object" || typeof call === "function")) { return call; } return MessageList_assertThisInitialized(self); }

function MessageList_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function MessageList_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }

function MessageList_getPrototypeOf(o) { MessageList_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return MessageList_getPrototypeOf(o); }

function MessageList_inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }




var MessageList_MessageList = /*#__PURE__*/function (_Component) {
  MessageList_inheritsLoose(MessageList, _Component);

  var _super = MessageList_createSuper(MessageList);
...
function SendIcon_createSuper(Derived) { return function () { var Super = SendIcon_getPrototypeOf(Derived), result; if (SendIcon_isNativeReflectConstruct()) { var NewTarget = SendIcon_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return SendIcon_possibleConstructorReturn(this, result); }; }

function SendIcon_possibleConstructorReturn(self, call) { if (call && (typeof call === "object" || typeof call === "function")) { return call; } return SendIcon_assertThisInitialized(self); }

function SendIcon_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function SendIcon_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }

function SendIcon_getPrototypeOf(o) { SendIcon_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return SendIcon_getPrototypeOf(o); }

function SendIcon_inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
var SendIcon_SendIcon = /*#__PURE__*/function (_Component) {
  ...
  var _super = SendIcon_createSuper(SendIcon);
...
function PopupWindow_createSuper(Derived) { return function () { var Super = PopupWindow_getPrototypeOf(Derived), result; if (PopupWindow_isNativeReflectConstruct()) { var NewTarget = PopupWindow_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return PopupWindow_possibleConstructorReturn(this, result); }; }

function PopupWindow_possibleConstructorReturn(self, call) { if (call && (typeof call === "object" || typeof call === "function")) { return call; } return PopupWindow_assertThisInitialized(self); }

function PopupWindow_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function PopupWindow_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }

function PopupWindow_getPrototypeOf(o) { PopupWindow_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return PopupWindow_getPrototypeOf(o); }

function PopupWindow_inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
var PopupWindow_PopupWindow = /*#__PURE__*/function (_Component) {
  ...
  var _super = PopupWindow_createSuper(PopupWindow);
  ...
  function PopupWindow() {
    ...
    _defineProperty(PopupWindow_assertThisInitialized(_this), "interceptLauncherClick", function (e) {
...
function UserInput_createSuper(Derived) { return function () { var Super = UserInput_getPrototypeOf(Derived), result; if (UserInput_isNativeReflectConstruct()) { var NewTarget = UserInput_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return UserInput_possibleConstructorReturn(this, result); }; }

function UserInput_possibleConstructorReturn(self, call) { if (call && (typeof call === "object" || typeof call === "function")) { return call; } return UserInput_assertThisInitialized(self); }
...
function UserInput_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }

function UserInput_getPrototypeOf(o) { UserInput_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return UserInput_getPrototypeOf(o); }

function UserInput_inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
var UserInput_UserInput = /*#__PURE__*/function (_Component) {
  ...
  var _super = UserInput_createSuper(UserInput);
...
UserInput_UserInput.propTypes = {
  ...
  showFile: prop_types_default.a.bool
};
...
function Header_createSuper(Derived) { return function () { var Super = Header_getPrototypeOf(Derived), result; if (Header_isNativeReflectConstruct()) { var NewTarget = Header_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return Header_possibleConstructorReturn(this, result); }; }

function Header_possibleConstructorReturn(self, call) { if (call && (typeof call === "object" || typeof call === "function")) { return call; } return Header_assertThisInitialized(self); }
...
var Header_Header = /*#__PURE__*/function (_Component) {
  Header_inheritsLoose(Header, _Component);
  ...
  _proto.render = function render() {
    ...
    }, " ", this.props.teamName, " "), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("div", {
...
function ChatWindow_createSuper(Derived) { return function () { var Super = ChatWindow_getPrototypeOf(Derived), result; if (ChatWindow_isNativeReflectConstruct()) { var NewTarget = ChatWindow_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return ChatWindow_possibleConstructorReturn(this, result); }; }

function ChatWindow_possibleConstructorReturn(self, call) { if (call && (typeof call === "object" || typeof call === "function")) { return call; } return ChatWindow_assertThisInitialized(self); }

function ChatWindow_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function ChatWindow_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }

function ChatWindow_getPrototypeOf(o) { ChatWindow_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return ChatWindow_getPrototypeOf(o); }

function ChatWindow_inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
var ChatWindow_ChatWindow = /*#__PURE__*/function (_Component) {
  ChatWindow_inheritsLoose(ChatWindow, _Component);

  var _super = ChatWindow_createSuper(ChatWindow);
...
function Launcher_createSuper(Derived) { return function () { var Super = Launcher_getPrototypeOf(Derived), result; if (Launcher_isNativeReflectConstruct()) { var NewTarget = Launcher_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return Launcher_possibleConstructorReturn(this, result); }; }

function Launcher_possibleConstructorReturn(self, call) { if (call && (typeof call === "object" || typeof call === "function")) { return call; } return Launcher_assertThisInitialized(self); }

function Launcher_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function Launcher_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }

function Launcher_getPrototypeOf(o) { Launcher_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Launcher_getPrototypeOf(o); }

function Launcher_inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
var Launcher_Launcher = /*#__PURE__*/function (_Component) {
  Launcher_inheritsLoose(Launcher, _Component);

  var _super = Launcher_createSuper(Launcher);
  ...
  _proto.render = function render() {
    ...
    }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Launcher_MessageCount, {
